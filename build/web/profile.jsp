<%-- 
    Document   : profile
    Created on : 05-Oct-2023, 3:32:42 pm
    Author     : Ankit
--%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
          <a class="nav-link" href="#"><span class="fa fa-coffee"></span>Code With Aman <span class="sr-only">(current)</span></a>
      </li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="container text-center">
              <img class="card-img-top" scr= "" alt="Card image cap" ><!-- comment -->
               <img class="card-img-top" src="pics/<%= User.getProfile()%>" alt="Card image cap">
              <br><!-- comment -->
